...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="span5">
          <h3 class="panel-title">Progress bars &amp; Sliders</h3>
          <div class="progress">
      ...
      <div class="row">
        ...
        <div class="span4">
          <div class="text-box prl">
            <h3 class="panel-title">Text Box</h3>
        ...
        <div class="span2">
          <h3 class="panel-title headings">Headings</h3>
          <h1>Header</h1>
          <h2>Header 2</h2>
          <h3>Header 3</h3>
          <h4>Header 4</h4>
      ...
      <h3 class="panel-title">Color Swatches</h3>
      <div class="row">
        <div class="span10">          
          <div class="row mbl">
            <div class="span2">
      ...
      <h3 class="panel-title">Icons <small>(14)</small></h3>
      <div class="illustrations">
        <div class="content">
          <div><img src="resources/images/icons/Toilet-Paper@2x.png" alt="Toilet-Paper"></div>          
          <div><img src="resources/images/icons/Gift-Box@2x.png" alt="Gift-Box"></div>
          <div><img src="resources/images/icons/Pensils@2x.png" alt="Pensils"></div>
          <div><img src="resources/images/icons/Clipboard@2x.png" alt="Clipboard"></div>
          <div><img src="resources/images/icons/Retina-Ready@2x.png" alt="Retina-Ready"></div>
          <div><img src="resources/images/icons/Compas@2x.png" alt="Compas"></div>
          <div><img src="resources/images/icons/Map@2x.png" alt="Map"></div>
          <div><img src="resources/images/icons/Chat@2x.png" alt="Chat"></div>
          <div><img src="resources/images/icons/Mail@2x.png" alt="Mail"></div>
          <div><img src="resources/images/icons/Book@2x.png" alt="Book"></div>
          <div><img src="resources/images/icons/Calendar@2x.png" alt="Calendar"></div>
          <div><img src="resources/images/icons/Pocket@2x.png" alt="Pocket"></div>
          <div><img src="resources/images/icons/Watches@2x.png" alt="Watches"></div>
          <div><img src="resources/images/icons/Infinity-Loop@2x.png" alt="Infinity-Loop"></div>
        </div>
      </div>


      <h3 class="panel-title">Glyphs <small>(30)</small></h3>
      <div class="icons">        
        <div class="content">
        ...
        <div class="span8 video">
          <!--[if !IE]> -->
            <video class="video-js" controls
              preload="auto" width="620" height="349" poster="resources/images/video/poster.jpg" data-setup="{}">
      ...
      <div class="row tiles">
        <div class="span3">
          <div class="tile">
            <img src="resources/images/icons/Compas@2x.png" alt="Compas@2x" class="tile-image big-illustration">
        ...
        <div class="span3">
          <div class="tile">
            <img src="resources/images/icons/Infinity-Loop@2x.png" alt="Infinity-Loop@2x" class="tile-image">
        ...
        <div class="span3">
          <div class="tile">
            <img src="resources/images/icons/Pensils@2x.png" alt="Pensils@2x" class="tile-image">
        ...
        <div class="span3">
          <div class="tile tile-hot">
            <img src="resources/images/icons/Chat@2x.png" alt="Chat@2x" class="tile-image">
      ...
      <div class="login">
        <div class="login-screen">
          <div class="login-icon">
            <img src="resources/images/login/icon.png" alt="Welcome to Mail App" />
      ...
      <div class="row">
        <div class="span9">
          <div class="browser">
            ...
            <div class="browser-content">
              <img src="resources/images/demo/browser-pic-1.jpg" alt="" />
              <img src="resources/images/demo/browser-pic-2.jpg" alt="" />
              <img src="resources/images/demo/browser-pic-3.jpg" alt="" />
              <img src="resources/images/demo/browser-pic-4.jpg" alt="" />
              <img src="resources/images/demo/browser-pic-5.jpg" alt="" />
              <img src="resources/images/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="span3">
          <div class="download">
            <img src="resources/images/demo/html-icon.png" src="Free PSD" />
          </div>

          <a href="https://github.com/designmodo/Flat-UI/archive/master.zip" class="btn btn-primary btn-large btn-block">Download</a>

          <p class="download-text">Your likes, shares and comments make us happy!</p>
        </div>
      </div> <!-- /download area -->
        ...
        <div class="row">
          <div class="span7">
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="resources/images/footer/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /span8 -->
