...
@Entity
@Table(name = "WEEKLY_AUDIT_EVENTS")
public class WeeklyAuditEvent {
	...
	public WeeklyAuditEvent() {
		mCount = new Integer(0);
	}

	public WeeklyAuditEvent(String event, String extra) {
		mEvent = event;
		mExtra = extra;
	...
	public boolean equals(Object obj) {
		if(obj instanceof WeeklyAuditEvent) {
			WeeklyAuditEvent that = (WeeklyAuditEvent) obj;
