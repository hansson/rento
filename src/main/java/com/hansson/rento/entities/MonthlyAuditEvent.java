...
@Entity
@Table(name = "MONTHLY_AUDIT_EVENTS")
public class MonthlyAuditEvent {
	...
	public MonthlyAuditEvent() {
		mCount = new Integer(0);
	}

	public MonthlyAuditEvent(String event, String extra) {
		mEvent = event;
		mExtra = extra;
	...
	public boolean equals(Object obj) {
		if(obj instanceof MonthlyAuditEvent) {
			MonthlyAuditEvent that = (MonthlyAuditEvent) obj;
